            ...
            <div class="col-lg-12">
                <div class="hero-body p-4 p-lg-5">
                    ...
                    <div class="hero-header-section">
                        <h1 class="hero-title h2 h1-lg mb-2 text-white"><i class="bi bi-list-ul fs-3" style="color: #F58439"></i>資產管理</h1>
                    ...
                    <div class="link-grid">
                        <a class="link-tile "
                           href="{{ url('/communityassets') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-clipboard2-pulse"></i></span>
                            <span>
                                <div class="tile-title">社區資產</div>
                                <div class="tile-desc">社區設備管理</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/carmanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-car-front-fill"></i></span>
                            <span>
                                <div class="tile-title">公務車管理</div>
                                <div class="tile-desc">公務車列表及管理</div>
                            </span>
                        </a>
