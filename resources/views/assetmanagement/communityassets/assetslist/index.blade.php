                        ...
                        <table class="table table-hover">
                            ...
                            @forelse($assets ?? [] as $asset)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ url('/addassets/'.$asset->id.'/edit') }}" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-pencil-square"></i> 編輯
                                        </a>
                                        <form action="{{ url('/addassets/'.$asset->id) }}" method="POST" class="d-inline" onsubmit="return confirm('確定刪除這個分類嗎？');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted">尚無分類資料，請先新增。</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
...
<div class="corner-dock" aria-label="右下角功能列">
    ...
    <a class="dock-btn is-active" href="{{ url('/assetslist') }}" style="text-decoration: none;"><i class="bi bi-bookmark-dash-fill"></i> 分類列表</a>
