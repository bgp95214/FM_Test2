                    ...
                    <tbody>
                        @foreach($humans as $human)
                            <tr>
                                ...
                                <td>{{ $human->hire_date }}</td>
                                <td>{{ $human->phone }}</td>
                                <td>{{ $human->email }}</td>
                                <td>
                                    <a href="{{ route('addhuman.edit', $human->id) }}" class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil-square"></i> 編輯
                                    </a>
                                    <form action="{{ route('addhuman.destroy', $human->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('確定要刪除此人員嗎？')">
...
<div class="corner-dock" aria-label="右下角功能列">
    ...
    <a class="dock-btn is-active" href="{{ url('/humanmanagement') }}" style="text-decoration: none;"><i class="bi bi-person-fill-gear"></i> 人員列表</a>
