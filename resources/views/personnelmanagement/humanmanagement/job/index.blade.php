...
<section class="ba-panel" aria-label="裝置清單">
    ...
    <div class="panel-body">
        ...
        @endif
        <h6 class="mb-3" style="color:#334155">職稱列表</h6>
        <div class="table-responsive">
            <table class="table table-hover">
                <thead class="table-light">
                    <tr>
                        <th scope="col">職位名稱</th>
                        <th scope="col">職稱內容</th>
                ...
                @forelse($jobs ?? [] as $j)
                    <tr>
                        ...
                        <td style="white-space: pre-wrap;">{{ $j->content }}</td>
                        <td class="text-center">
                            <a href="{{ url('/addjob/' . $j->id . '/edit') }}" class="btn btn-sm btn-outline-warning">
                                <i class="bi bi-pencil"></i> 編輯
                            </a>
                            <form method="POST" action="{{ url('/addjob/' . $j->id) }}" style="display:inline;">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center text-muted">尚無職稱資料</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
...
<div class="corner-dock" aria-label="右下角功能列">
    ...
    <a class="dock-btn is-active" href="{{ url('/job') }}" style="text-decoration: none;"><i class="bi bi-file-person"></i> 職稱列表</a>
