            ...
            <div class="col-lg-12">
                <div class="hero-body p-4 p-lg-5">
                    ...
                    <div class="hero-header-section">
                        <h1 class="hero-title h2 h1-lg mb-2 text-white"><i class="bi bi-person-lines-fill fs-3" style="color: #F58439"></i>人員管理</h1>
                        <p class="hero-text mb-0 text-white">
                            快速管理人員平台，住戶、廠商、組織、物業人員。
                        </p>
                    </div>
                    ...
                    <div class="link-grid">
                        <a class="link-tile "
                           href="{{ url('/residentmanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-house-gear-fill"></i></span>
                            <span>
                                <div class="tile-title">住戶管理</div>
                                <div class="tile-desc">住戶資料建置</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/organizationalmanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-diagram-3"></i></span>
                            <span>
                                <div class="tile-title">組織管理</div>
                                <div class="tile-desc">架構及成員管理</div>
                            </span>
                        </a>

                        <a class="link-tile "
                           href="{{ url('/humanmanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-person-fill-gear"></i></span>
                            <span>
                                <div class="tile-title">人事管理</div>
                                <div class="tile-desc">社區服務人員管理</div>
                            </span>
                        </a>

                        <a class="link-tile "
                           href="{{ url('/vendormanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-wrench-adjustable-circle"></i></span>
                            <span>
                                <div class="tile-title">廠商管理</div>
                                <div class="tile-desc">社區外包廠商管理</div>
                            </span>
                        </a>
