                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach($vendors as $vendor)
                            <tr>
                                <td>{{ $vendor->name }}</td>
                                <td>{{ $vendor->service_item }}</td>
                                <td>{{ $vendor->contact_person }}</td>
                                <td>{{ $vendor->phone }}</td>
                                <td>{{ $vendor->email }}</td>
                                <td>
                                    <a href="{{ route('addvendor.edit', $vendor->id) }}" class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil-square"></i> 編輯
                                    </a>
                                    <form action="{{ route('addvendor.destroy', $vendor->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('確定要刪除此廠商嗎？')">
...
<div class="corner-dock" aria-label="右下角功能列">
    ...
    <a class="dock-btn is-active" href="{{ url('/vendormanagement') }}" style="text-decoration: none;"><i class="bi bi-file-person"></i> 廠商列表</a>
</div>
