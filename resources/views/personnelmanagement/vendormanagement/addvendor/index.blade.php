    ...
    <div class="panel-body">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form action="{{ route('addvendor.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="service_item" name="service_item" required>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">新增廠商</button>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="corner-dock" aria-label="右下角功能列">
    <a class="dock-btn is-active" href="{{ url('/addvendor') }}" style="text-decoration: none;"><i class="bi bi-file-earmark-plus"></i> 新增廠商</a>
