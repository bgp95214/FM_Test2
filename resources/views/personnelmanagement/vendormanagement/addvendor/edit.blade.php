    ...
    <div class="panel-body">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <h4 class="mb-4">編輯廠商資料</h4>
                    <form action="{{ route('addvendor.update', $vendor->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            <label for="service_item" class="form-label">服務項目</label>
                            <input type="text" class="form-control" id="service_item" name="service_item" value="{{ $vendor->service_item }}" required>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                            <button type="submit" class="btn btn-primary">更新廠商</button>
                            <a href="{{ url('/vendormanagement') }}" class="btn btn-secondary">取消</a>
                        </div>
                    </form>
                </div>
            </div>
...
<nav class="quick-toolbar" aria-label="快速工具列">
    ...
    <a class="floor-btn d-flex flex-column align-items-center justify-content-center gap-1 is-active" href="{{ url('/vendormanagement') }}" >
...
<div class="corner-dock" aria-label="右下角功能列">
    <a class="dock-btn " href="{{ url('/addvendor') }}" style="text-decoration: none;"><i class="bi bi-file-earmark-plus"></i> 新增廠商</a>
    <a class="dock-btn" href="{{ url('/vendormanagement') }}" style="text-decoration: none;"><i class="bi bi-file-person"></i> 廠商列表</a>
</div>
