                        ...
                        <table class="table table-hover">
                            ...
                            @forelse($floors ?? [] as $floor)
                                <tr>
                                    ...
                                    <td>{{ $floor->created_at->format('Y/m/d H:i') }}</td>
                                    <td class="text-end">
                                        <a href="{{ url('/addfloor/'.$floor->id.'/edit') }}" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-pencil-square"></i> 編輯
                                        </a>
                                        <form action="{{ url('/addfloor/'.$floor->id) }}" method="POST" class="d-inline" onsubmit="return confirm('確定刪除這個樓層嗎？');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted">尚無樓層資料，請先新增。</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
...
<div class="corner-dock" aria-label="右下角功能列">
    ...
    <a class="dock-btn is-active" href="{{ url('/floors') }}" style="text-decoration: none;"><i class="bi bi-building"></i> 樓層清單</a>
