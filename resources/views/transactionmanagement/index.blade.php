            ...
            <div class="col-lg-12">
                <div class="hero-body p-4 p-lg-5">
                    ...
                    <div class="hero-header-section">
                        <h1 class="hero-title h2 h1-lg mb-2 text-white"><i class="bi bi-clipboard2 fs-3" style="color: #F58439"></i>事務管理</h1>
                        <p class="hero-text mb-0 text-white">
                            快速管理社區事務平台，包裹、維修、預約、公告。
                        </p>
                    </div>
                    ...
                    <div class="link-grid">
                        <a class="link-tile "
                           href="{{ url('/packagemanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-box-seam"></i></span>
                            <span>
                                <div class="tile-title">包裹管理</div>
                                <div class="tile-desc">包裹事務管理</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/repairmanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-screwdriver"></i></span>
                            <span>
                                <div class="tile-title">報修管理</div>
                                <div class="tile-desc">報修表單簽核</div>
                            </span>
                        </a>

                        <a class="link-tile "
                           href="{{ url('/publicmanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-clipboard2-check"></i></span>
                            <span>
                                <div class="tile-title">公設管理</div>
                                <div class="tile-desc">公設預約及管理</div>
                            </span>
                        </a>

                        <a class="link-tile "
                           href="{{ url('/carapproval') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-clipboard-check"></i></span>
                            <span>
                                <div class="tile-title">公務車預約</div>
                                <div class="tile-desc">公務車預約表單簽核</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           ...
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-wrench"></i></span>
                            <span>
                                <div class="tile-title">維修管理</div>
                                <div class="tile-desc">維修安排處理</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/announcementmanagement') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-window-fullscreen"></i></span>
                            <span>
                                <div class="tile-title">公告管理</div>
                                <div class="tile-desc">公告事項管理</div>
                            </span>
                        </a>
