...
<section class="ba-panel" aria-label="裝置清單">
    ...
    <div class="panel-body">
        <div class="container-fluid">
            @if(isset($plan) && $plan)
                <div class="card">
                    <div class="card-header">最新維護計劃（更新於：{{ $plan->updated_at->timezone('Asia/Taipei')->format('Y-m-d H:i:s') }}）</div>
...
<div class="corner-dock" aria-label="右下角功能列">
    <a class="dock-btn " href="{{ url('/editmaintenance') }}" style="text-decoration: none;"><i class="bi bi-pencil-square"></i> 編輯計劃</a>
    <a class="dock-btn is-active" href="{{ url('/maintenanceplan') }}" style="text-decoration: none;"><i class="bi bi-journal-code"></i> 計劃內容</a>
</div>
