            ...
            <div class="col-lg-12">
                <div class="hero-body p-4 p-lg-5">
                    ...
                    <div class="hero-header-section">
                        <h1 class="hero-title h2 h1-lg mb-2 text-white"><i class="bi bi-journal-bookmark-fill fs-3" style="color: #F58439"></i>規範管理</h1>
                    ...
                    <div class="link-grid">
                        <a class="link-tile "
                           href="{{ url('/maintenanceplan') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-journal-code"></i></span>
                            <span>
                                <div class="tile-title">維護計劃</div>
                                <div class="tile-desc">社區使用計劃書</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/processspecifications') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-journal-text"></i></span>
                            <span>
                                <div class="tile-title">流程規範</div>
                                <div class="tile-desc">社區SOP計劃書</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/materialsplan') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-journal-album"></i></span>
                            <span>
                                <div class="tile-title">資材計劃</div>
                                <div class="tile-desc">社區設備維護計劃書</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/longtimeplan') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-journal-richtext"></i></span>
                            <span>
                                <div class="tile-title">長期計劃</div>
                                <div class="tile-desc">社區長期維護計劃書</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/residentsregulations') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-journal-medical"></i></span>
                            <span>
                                <div class="tile-title">住戶規章</div>
                                <div class="tile-desc">社區規章編輯</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/administrativeforms') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-journals"></i></span>
                            <span>
                                <div class="tile-title">行政表單</div>
                                <div class="tile-desc">例會表單等各式表單建立</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/communityreports') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-file-bar-graph"></i></span>
                            <span>
                                <div class="tile-title">社區報表</div>
                                <div class="tile-desc">耗能報表，財務報表建立</div>
                            </span>
                        </a>
