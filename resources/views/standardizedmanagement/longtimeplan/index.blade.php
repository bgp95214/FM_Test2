...
<section class="ba-panel" aria-label="裝置清單">
    ...
    <div class="panel-body">
        <div class="container-fluid">
            @if(isset($longtime) && $longtime)
                <div class="card">
                    <div class="card-header">最新規範內容（更新於：{{ $longtime->updated_at->timezone('Asia/Taipei')->format('Y-m-d H:i:s') }}）</div>
                    <div class="card-body" style="white-space: pre-line;">
                        {{ ltrim($longtime->content) }}
                    </div>
                </div>
            @else
...
<div class="corner-dock" aria-label="右下角功能列">
    <a class="dock-btn " href="{{ url('/editlongtime') }}" style="text-decoration: none;"><i class="bi bi-pencil-square"></i> 編輯計劃</a>
    <a class="dock-btn is-active" href="{{ url('/longtimeplan') }}" style="text-decoration: none;"><i class="bi bi-journal-richtext"></i> 計劃內容</a>
</div>
