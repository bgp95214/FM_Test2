    ...
    <div class="panel-body">
        <div class="container-fluid">
            @if(isset($process) && $process)
                <div class="card">
                    <div class="card-header">最新維護計劃（更新於：{{ $process->updated_at->timezone('Asia/Taipei')->format('Y-m-d H:i:s') }}）</div>
                    <div class="card-body" style="white-space: pre-line;">
                        {{ ltrim($process->content) }}
                    </div>
                </div>
            @else
...
<div class="corner-dock" aria-label="右下角功能列">
    <a class="dock-btn " href="{{ url('/editprocesss') }}" style="text-decoration: none;"><i class="bi bi-pencil-square"></i> 編輯規範</a>
    <a class="dock-btn is-active" href="{{ url('/processspecifications') }}" style="text-decoration: none;"><i class="bi bi-journal-text"></i> 規範內容</a>
</div>
