            ...
            <div class="col-lg-12">
                <div class="hero-body p-4 p-lg-5">
                    ...
                    <div class="hero-header-section">
                        <h1 class="hero-title h2 h1-lg mb-2 text-white"><i class="bi bi-cash-stack fs-3" style="color: #F58439"></i>財務管理</h1>
                        <p class="hero-text mb-0 text-white">
                            快速管理社區財務平台，日常收費、應付帳款、表單列印。
                        </p>
                    </div>
                    ...
                    <div class="link-grid">
                        <a class="link-tile "
                           ...
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-piggy-bank"></i></span>
                            <span>
                                <div class="tile-title">日常收費</div>
                                <div class="tile-desc">社區日常收費管理整合</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           href="{{ url('/repairlist') }}"
                           target="_blank"
                           rel="noopener noreferrer">
                            <span class="tile-icon"><i class="bi bi-coin"></i></span>
                            <span>
                                <div class="tile-title">日常應付</div>
                                <div class="tile-desc">社區日常應付紀錄整合</div>
                            </span>
                        </a>
                        <a class="link-tile "
                           ...
                           rel="noopener noreferrer">
                            ...
                            <span>
                                <div class="tile-title">表單列印</div>
                                <div class="tile-desc">社區各式表單留存列印</div>
                            </span>
                        </a>
